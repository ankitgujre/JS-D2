...
// console.log(`Ankit ${13+10}`)

// console.log("ankit".split(''))
// console.log("Hello bhai kese ho".split('h'))
console.log("Hello bhai kese ho".replace('h','g'))  // h ko replace kardiya g se lekin sirf pehle vala
console.log("Hello bhai kese ho".replaceAll('h','g')) // sare ko change karne ke liye
